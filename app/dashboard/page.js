...
export default function DashboardPage() {
  ...
  async function fetchDashboard() {
    try {
      ...
      setRecentReminders(data.recentReminders || []);
    } catch (error) {
      console.error(error);
    }
  }
      ...
      <div className="mx-auto max-w-7xl px-6 py-10">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          ...
          <div className="rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm">
            ...
            <h3 className="mt-2 text-3xl font-bold">{stats.totalReminders}</h3>
          </div>
          ...
          <div className="rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm">
            ...
            <p className="text-sm text-zinc-500">Active Reminder</p>

            <h3 className="mt-2 text-3xl font-bold">{stats.activeReminders}</h3>
          </div>
        ...
        <div className="mt-10 rounded-3xl border border-zinc-200 bg-white p-8 shadow-sm">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-2xl font-semibold">Recent Reminders</h3>

              <p className="mt-2 text-zinc-600">
                Reminder terbaru yang dibuat.
              </p>
            </div>
          </div>
          ...
          <div className="mt-8 space-y-4">
            {recentReminders.length > 0 ? (
              recentReminders.map((reminder) => (
                <div
                  key={reminder.id}
                  className="flex flex-col gap-4 rounded-2xl border border-zinc-200 p-5 md:flex-row md:items-center md:justify-between"
                >
                  <div>
              ...
              <p className="text-sm text-zinc-500">Belum ada reminder.</p>
            )}
          </div>
        </div>
